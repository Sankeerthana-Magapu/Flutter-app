...
- 💰 **Coin System** — Earn coins for correct answers and milestones  
- 🔥 **Daily Streaks** — Encourages consistent learning and practice  
- 🧾 **Quiz History** — Keeps track of your completed quizzes  
- 👤 **User Profile** — Saves progress locally using SharedPreferences  
- 🧩 **Dynamic UI** — Built with Flutter Material 3 and adaptive color schemes  
